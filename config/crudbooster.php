...
return [
    ...
    *
    * Boxed Layout:        use the class .layouts-boxed to get a boxed layouts that stretches only to 1250px.
    *                      Provides spaces on both sides of the screen, if the screen is big enough.
    *
    * Top Navigation:      use the class .layouts-top-nav to remove the sidebar and have your links at the top navbar.
    ...
    * sidebar-mini
    *
    * Note: you cannot use both layouts-boxed and fixed at the same time. Anything else can be mixed together.
    */
